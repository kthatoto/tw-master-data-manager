...
.resources
  ...
  .resources__content.content(v-if="!showingResource")
    .resources__item(v-for="o in directories" :key="o.name" @click="selectResource(o.id)" :class="{selected: selectingResourceId === o.id}")
    ...
    .resources__item(v-for="o in resources" :key="o.name" @click="selectingResourceId = o.id" :class="{selected: selectingResourceId === o.id}")
      .focus(v-if="selectingResourceId === o.id")
      ConsoleImage(
