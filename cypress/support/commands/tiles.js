Cypress.Commands.add('createTile', (imageName, tileName, expectedMessage) => {
  ...
  cy.wait(100)
  cy.contains('.dialog.-tileCreate', 'Image選択').click()
  cy.wait(100)
  cy.contains('.image-selector', imageName).find('img').click()
  cy.contains('.el-dialog .el-dialog__footer', '選択').click()
  cy.wait(100)
  cy.get('.dialog.-tileCreate input.el-input__inner').clear().type(imageName)
